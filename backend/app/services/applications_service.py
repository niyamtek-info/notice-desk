...
BULK_SARFAESI_FIELD_MAP = {
    ...
    "CIF_NO": "cif_no",
    "BORROWER_EMAIL_ID": "borrower_email",
    "BORROWER_NUMBER": "borrower_number",
    "BORROWER_RANGE": "borrower_range",
    "CO_BORROWER_RANGE": "co_borrower_range",
    "CO_BORROWER_EMAIL_1": "co_borrower_1_email",
    "CO_BORROWER_NUMBER_1": "co_borrower_1_number",
    "CO_BORROWER_EMAIL_2": "co_borrower_2_email",
    "CO_BORROWER_NUMBER_2": "co_borrower_2_number",
    "CO_BORROWER_EMAIL_3": "co_borrower_3_email",
    "CO_BORROWER_NUMBER_3": "co_borrower_3_number",
    "CO_BORROWER_EMAIL_4": "co_borrower_4_email",
    "CO_BORROWER_NUMBER_4": "co_borrower_4_number",
    "CO_BORROWER_EMAIL_5": "co_borrower_5_email",
    "CO_BORROWER_NUMBER_5": "co_borrower_5_number",
    "CO_BORROWER_EMAIL_6": "co_borrower_6_email",
    "CO_BORROWER_NUMBER_6": "co_borrower_6_number",
    "MORTGAGOR_NAME_1": "mortager_name_1",
    "MORTGAGOR_ADDRESS_1": "mortager_address_1",
    "MORTGAGOR_NAME_2": "mortager_name_2",
    "MORTGAGOR_ADDRESS_2": "mortager_address_2",
    "COLLATERAL_PROPERTY_DESCRIPTION_SANCTION": "collateral_property_description",
    "MODEL_OF_MACHINERY": "model_of_machinery",
    "MANUFACTURER": "manufacturer",
    "CATEGORY_OF_MACHINERY": "category_of_machinery",
    "DEALER_NAME": "dealer_name",
    "TYPE_OF_MACHINE": "type_of_machine",
    "PROPERTY_NAME": "property_name",
    "SANCTION_DATE": "sanction_date",
    "SANCTION_DATE_IN_WORDS": "sanction_date_words",
    "SANCTION_AMOUNT": "sanction_amount",
    "PENDING_EMI": "pending_emi",
    "INTEREST_FOR_THE_MONTH": "interest_for_the_month",
    "LRN_DATE": "lrn_date",
    "LRN_DATE_IN_WORDS": "lrn_date_words",
    "LRN_DISPATCH_DATE": "lrn_dispatch_date",
    "PRE_SARFAESI_DATE": "pre_sarfeasi_date",
    "PRE_SARFAESI_DATE_IN_WORDS": "pre_sarfeasi_date_words",
    "PRE_SARFAESI_DISPATCH_DATE": "pre_sarfeasi_dispatch_date",
    "DEMAND_NOTICE_DATE_IN_WORDS": "demand_notice_date_words",
...
class ApplicationsService:
                    ...
                    if is_update_scenario and existing_app:
                        ...
                        try:
                            ...
                            field_to_section_map = {
                                ...
                                "cif_no": "loan_details",
                                "borrower_email": "loan_details",
                                "borrower_number": "loan_details",
                                "borrower_range": "loan_details",
                                "co_borrower_range": "loan_details",
                                "co_borrower_1_email": "loan_details",
                                "co_borrower_1_number": "loan_details",
                                "co_borrower_2_email": "loan_details",
                                "co_borrower_2_number": "loan_details",
                                "co_borrower_3_email": "loan_details",
                                "co_borrower_3_number": "loan_details",
                                "co_borrower_4_email": "loan_details",
                                "co_borrower_4_number": "loan_details",
                                "co_borrower_5_email": "loan_details",
                                "co_borrower_5_number": "loan_details",
                                "co_borrower_6_email": "loan_details",
                                "co_borrower_6_number": "loan_details",
                                "mortager_name_1": "loan_details",
                                "mortager_address_1": "loan_details",
                                "mortager_name_2": "loan_details",
                                "mortager_address_2": "loan_details",
                                "collateral_property_description": "loan_details",
                                "model_of_machinery": "loan_details",
                                "manufacturer": "loan_details",
                                "category_of_machinery": "loan_details",
                                "dealer_name": "loan_details",
                                "type_of_machine": "loan_details",
                                "property_name": "loan_details",
                                "sanction_date": "loan_details",
                                "sanction_date_words": "loan_details",
                                "sanction_amount": "loan_details",
                                "pending_emi": "loan_details",
                                "interest_for_the_month": "loan_details",
                                "lrn_date": "loan_details",
                                "lrn_date_words": "loan_details",
                                "lrn_dispatch_date": "loan_details",
                                "pre_sarfeasi_date": "loan_details",
                                "pre_sarfeasi_date_words": "loan_details",
                                "pre_sarfeasi_dispatch_date": "loan_details",
                                "demand_notice_date_words": "13_2_details",
    ...
    def download_template(self):
        columns = [
            ...
            "Co-borrower range",
            "Co-borrower email 1",
            "Co-borrower number 1",
            "Co-borrower email 2",
            "Co-borrower number 2",
            "Co-borrower email 3",
            "Co-borrower number 3",
            "Co-borrower email 4",
            "Co-borrower number 4",
            "Co-borrower email 5",
            "Co-borrower number 5",
            "Co-borrower email 6",
            "Co-borrower number 6",
            "Mortgagor name 1",
            "Mortgagor address 1",
            "Mortgagor name 2",
            "Mortgagor address 2",
            "Collateral property description (sanction)",
            "Model of machinery",
            "Manufacturer",
            ...
            "Lrn dispatch date",
            "Pre sarfaesi date",
            "Pre sarfaesi date in words",
            "Pre sarfaesi dispatch date",
            "Demand notice date in words",
        ]
