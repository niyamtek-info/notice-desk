    ...
    def _format_response(self, s):
        ...
        return {
            ...
            "loan_details": {
                ...
                "pos": s.pos,
                "sarfaesi_category": s.sarfaesi_category,
                ...
                "borrower_number": s.borrower_number,
                "borrower_range": s.borrower_range,
                "co_borrower_1_email": s.co_borrower_1_email,
                "co_borrower_1_number": s.co_borrower_1_number,
                "co_borrower_2_email": s.co_borrower_2_email,
                "co_borrower_2_number": s.co_borrower_2_number,
                "co_borrower_3_email": s.co_borrower_3_email,
                "co_borrower_3_number": s.co_borrower_3_number,
                "co_borrower_4_email": s.co_borrower_4_email,
                "co_borrower_4_number": s.co_borrower_4_number,
                "co_borrower_5_email": s.co_borrower_5_email,
                "co_borrower_5_number": s.co_borrower_5_number,
                "co_borrower_6_email": s.co_borrower_6_email,
                "co_borrower_6_number": s.co_borrower_6_number,
                "co_borrower_range": s.co_borrower_range,
                "mortager_name_1": s.mortager_name_1,
                "mortager_address_1": s.mortager_address_1,
                "mortager_name_2": s.mortager_name_2,
                "mortager_address_2": s.mortager_address_2,
                "collateral_property_description": s.collateral_property_description,
                "model_of_machinery": s.model_of_machinery,
                "manufacturer": s.manufacturer,
                "category_of_machinery": s.category_of_machinery,
                "dealer_name": s.dealer_name,
                "type_of_machine": s.type_of_machine,
                "property_name": s.property_name,
                "sanction_date": s.sanction_date,
                "sanction_date_words": s.sanction_date_words,
                "sanction_amount": self._format_indian_amount(s.sanction_amount),
                "pending_emi": self._format_indian_amount(s.pending_emi),
                "interest_for_the_month": self._format_indian_amount(s.interest_for_the_month),
                "lrn_date": s.lrn_date,
                "lrn_date_words": s.lrn_date_words,
                "lrn_dispatch_date": s.lrn_dispatch_date,
                "pre_sarfeasi_date": s.pre_sarfeasi_date,
                "pre_sarfeasi_date_words": s.pre_sarfeasi_date_words,
                "pre_sarfeasi_dispatch_date": s.pre_sarfeasi_dispatch_date,
            },
            ...
            "13_2_details": {
                ...
                "demand_notice_date_words": s.demand_notice_date_words,
            },
